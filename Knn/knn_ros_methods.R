...
prep_test$prediction <- knn(prep_train[c(21:28)],prep_test[c(21:28)],cl=prep_train$is_smell,k=1)
...
capture.output(cm, file = sprintf("%s_knn.csv",recognized_smell))

jpeg(sprintf("%s_knn.jpeg",recognized_smell), width = 500, height = 500)
