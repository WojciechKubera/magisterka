...
rf <- randomForest(is_smell~.,data=prep_train[c(21:44, 47)], ntree=500)

print(rf)
floor(sqrt(ncol(prep_train[c(21:44)]) - 1))

mtry <- tuneRF(prep_train[c(21:44)],prep_train$is_smell, ntreeTry=500,
               stepFactor=1.5,improve=0.01, trace=TRUE, plot=TRUE)
best.m <- mtry[mtry[, 2] == min(mtry[, 2]), 1]
print(mtry)
print(best.m)

rf <-randomForest(is_smell~.,data=prep_train[c(21:44,47)], mtry=best.m, importance=TRUE,ntree=500)
print(rf)
