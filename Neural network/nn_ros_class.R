...
metrics_all <- data.matrix(methods_all[c(19:23, 26:50)])
# metrics <- normalize(data.matrix(methods_all[21:45]))

metrics_train <- data.matrix(prep_train[c(19:23, 26:50)])
